...
export default function CreateAuctionModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className="absolute inset-0 bg-neutral-950/50 animate-fadeIn"
        onClick={onClose}
      ></div>

      {/* Content Box */}
      <div className="bg-white dark:bg-neutral-900 rounded-md border border-neutral-200 dark:border-neutral-800 shadow-md w-full max-w-3xl relative z-10 max-h-[90vh] overflow-y-auto p-6 md:p-8 animate-fadeIn flex flex-col md:flex-row gap-8">
        
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-neutral-400 hover:text-neutral-900 dark:hover:text-white rounded-md transition-colors cursor-pointer"
        >
          <svg
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-4">
          ...
          <div
            ...
            className="w-full aspect-square md:flex-1 rounded-md border-2 border-dashed border-neutral-300 dark:border-neutral-700 flex flex-col items-center justify-center p-4 text-center hover:bg-neutral-50 dark:hover:bg-neutral-800/40 cursor-pointer transition-colors duration-200 relative overflow-hidden select-none"
          >
            {filePreview ? (
              <img src={filePreview} alt="Preview" className="w-full h-full object-cover rounded-sm" />
            ) : (
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-md text-[10px] focus:outline-none focus:ring-1 focus:ring-neutral-900 dark:focus:ring-white transition-all text-neutral-900 dark:text-white"
            />
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-4">
          ...
          {error && (
            <div className="p-3 bg-rose-500/10 border border-rose-500/20 text-rose-500 rounded-md text-xs font-semibold">
              {error}
            </div>
          )}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="px-4 py-2.5 bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-md text-xs focus:border-neutral-900 dark:focus:border-white focus:outline-none transition-all text-neutral-900 dark:text-white"
              required
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="px-4 py-2.5 bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-md text-xs min-h-[70px] focus:border-neutral-900 dark:focus:border-white focus:outline-none transition-all text-neutral-900 dark:text-white resize-y"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="px-4 py-2.5 bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-md text-xs font-bold focus:border-neutral-900 dark:focus:border-white focus:outline-none transition-all text-neutral-900 dark:text-white"
                required
              />
            </div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-neutral-100 dark:border-neutral-800 mt-4">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2.5 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-750 text-neutral-700 dark:text-neutral-300 rounded-md text-xs font-bold transition-colors cursor-pointer select-none"
            >
              Hủy bỏ
            </button>
            <button
              type="submit"
              disabled={loading}
              className={`px-6 py-2.5 rounded-md text-xs font-bold transition-colors cursor-pointer select-none ${
                loading
